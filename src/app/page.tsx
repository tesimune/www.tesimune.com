                  ...
                  <motion.div key={project.id} variants={fadeInUp}>
                    <Card className="overflow-hidden bg-gray-800/50 border-gray-700 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300">
                      ...
                      <div className="m-5">
                        ...
                        <p className="text-gray-300 h-10 mb-4">
                          {project.description}
                        </p>
                        <div className="h-24">
                ...
                {experience.map((exp) => (
                  <motion.div key={exp.id} variants={fadeInUp}>
                    <Card className="p-6 bg-gray-800/50 border-gray-700 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300">
                      ...
                      <h4 className="text-lg text-gray-300 mb-2 uppercase">
                        {exp.company}
                      </h4>
                ...
                <Card className="p-6 bg-gray-800/50 border-gray-700 hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        icon: MailIcon,
                        text: "tesimune@gmail.com",
                        href: "mailto:tesimune@gmail.com",
                      },
                      {
                        icon: LinkedinIcon,
                        text: "linkedin.com/in/tesimune",
                        href: "https://linkedin.com/in/tesimune",
                      },
                      {
                        icon: TwitterIcon,
                        text: "twitter.com/tesimune",
                        href: "https://twitter.com/tesimune",
                      },
                      ...
                      // {
                      //   icon: PhoneIcon,
                      //   text: "+234 806 798 8642",
                      //   href: "tel:+2348067988642",
                      // },
                    ].map((item, index) => (
                      <motion.div
                        key={index}
